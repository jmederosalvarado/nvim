...
H.apply_palette = function(palette, use_cterm)
  ...
  -- hi('CursorLineFold', {fg=p.base0C, bg=nil     , attr=nil,            sp=nil})
  ...
  hi('ColorColumn',  {fg=nil,          bg=p.black2,       attr=nil, sp=nil})
  hi('Conceal',      {fg=nil,          bg=nil,            attr=nil, sp=nil})
  hi('Cursor',       {fg=p.base00,     bg=p.base05,       attr=nil, sp=nil})
  hi('CursorColumn', {fg=nil,          bg=p.base01,       attr=nil, sp=nil})
  hi('CursorLine',   {fg=nil,          bg=p.black2,       attr=nil, sp=nil})
  hi('CursorLineNr', {fg=p.white,      bg=nil,            attr=nil, sp=nil})
  hi('Directory',    {fg=p.base0D,     bg=nil,            attr=nil, sp=nil})
  hi('ErrorMsg',     {fg=p.base08,     bg=p.base00,       attr=nil, sp=nil})
  hi('FoldColumn',   {fg=nil,          bg=nil,            attr=nil, sp=nil})
  hi('Folded',       {fg=p.light_grey, bg=p.black2,       attr=nil, sp=nil})
  hi('FloatBorder',  {fg = p.blue,     bg=nil,            attr=nil, sp=nil})
  hi('FloatTitle',   {fg = p.white,    bg = p.grey,       attr=nil, sp=nil})
  hi('IncSearch',    {fg=p.base01,     bg=p.base09,       attr=nil, sp=nil})
  hi('LineNr',       {fg=p.grey,       bg=nil,            attr=nil, sp=nil})
  hi('MatchWord',    {fg=p.white,      bg=p.grey,         attr=nil, sp=nil})
  ...
  hi('NormalFloat',  {fg=nil,          bg=p.darker_black, attr=nil, sp=nil})
  hi('Pmenu',        {fg=nil,          bg=p.one_bg,       attr=nil, sp=nil})
  hi('PmenuSbar',    {fg=nil,          bg=p.one_bg,       attr=nil, sp=nil})
  hi('PmenuSel',     {fg=p.black,      bg=p.pmenu_bg,     attr=nil, sp=nil})
  hi('PmenuThumb',   {fg=nil,          bg=p.grey,         attr=nil, sp=nil})
  ...
  hi('WinBar',       {fg=nil,          bg=nil,            attr=nil, sp=nil})
  hi('WinBarNC',     {fg=nil,          bg=nil,            attr=nil, sp=nil})
  hi('WinSeparator', {fg=p.line,       bg=nil,            attr=nil, sp=nil})
  ...
  hi('Comment',        {fg=p.base03, bg=nil,      attr=nil, sp=nil}) -- was fg=light_grey
  ...
  -- Diff
  hi('Added',            {fg=p.green,      bg=nil,                  attr=nil, sp=nil}) -- was fg=base0B
  hi('Changed',          {fg=p.yellow,     bg=nil,                  attr=nil, sp=nil}) -- was fg=base0E
  hi('Removed',          {fg=p.red,        bg=nil,                  attr=nil, sp=nil}) -- was fg=base08
  hi('DiffAdd',          {fg=p.green,      bg=H.blend(p.green,      p.black,  90), attr=nil, sp=nil})
  hi('DiffChange',       {fg=p.light_grey, bg=H.blend(p.light_grey, p.black,  90), attr=nil, sp=nil}) -- was fg=base0E bg=base01
  hi('DiffDelete',       {fg=p.red,        bg=H.blend(p.red,        p.black,  90), attr=nil, sp=nil}) -- was fg=base08 bg=base01
  hi('DiffText',         {fg=p.white,      bg=p.black2,             attr=nil, sp=nil}) -- was fg=base0D bg=base01
    -- These don't seem to be in the default Neovim hl-groups
  hi('diffAdded',        {fg=p.green,      bg=H.blend(p.green,      p.black,  90), attr=nil, sp=nil}) -- was fg=base0B
  hi('diffChanged',      {fg=p.base0E,     bg=nil,                  attr=nil, sp=nil}) -- was fg=base0E
  hi('diffFile',         {fg=p.base09,     bg=nil,                  attr=nil, sp=nil}) -- was fg=base09
  hi('diffLine',         {fg=p.base0C,     bg=nil,                  attr=nil, sp=nil}) -- was fg=base0C
  hi('diffRemoved',      {fg=p.base08,     bg=nil,                  attr=nil, sp=nil}) -- was fg=base08
  hi('DiffModified',     {fg=p.orange,     bg=H.blend(p.orange,     p.black,  90), attr=nil, sp=nil})
  hi('DiffAdded',        {link="DiffAdd"})
  hi('DiffRemoved',      {link="DiffDelete"})
  hi('DiffChangeDelete', {link="DiffDelete"})
  ...
  hi('gitcommitSelectedFile',  {link='gitcommitDiscardedFile'})
  ...
  -- Built-in diagnostic
  hi('DiagnosticError', {fg=p.red,    bg=nil, attr=nil, sp=nil}) -- was fg=base08
  hi('DiagnosticHint',  {fg=p.purple, bg=nil, attr=nil, sp=nil}) -- was fg=base0D
  hi('DiagnosticInfo',  {fg=p.green,  bg=nil, attr=nil, sp=nil}) -- was fg=base0C
  hi('DiagnosticOk',    {fg=p.green,  bg=nil, attr=nil, sp=nil}) -- was fg=base0B
  hi('DiagnosticWarn',  {fg=p.yellow, bg=nil, attr=nil, sp=nil}) -- was fg=base0E

  hi('DiagnosticFloatingError', {fg=p.base08, bg=p.black2, attr=nil, sp=nil}) -- was fg=base08 bg=base01
  hi('DiagnosticFloatingHint',  {fg=p.base0D, bg=p.black2, attr=nil, sp=nil}) -- was fg=base0D bg=base01
  hi('DiagnosticFloatingInfo',  {fg=p.base0C, bg=p.black2, attr=nil, sp=nil}) -- was fg=base0C bg=base01
  hi('DiagnosticFloatingOk',    {fg=p.base0B, bg=p.black2, attr=nil, sp=nil}) -- was fg=base0B bg=base01
  hi('DiagnosticFloatingWarn',  {fg=p.base0E, bg=p.black2, attr=nil, sp=nil}) -- was fg=base0E bg=base01
  ...
  -- Built-in LSP
  hi('LspReferenceText',  {fg=nil, bg=p.one_bg3, attr=nil, sp=nil}) -- was bg=base02
